...
- Copy, redistribute, sublicense, sell, lease, or otherwise transfer the Software.
- Host the Software or make it accessible to third parties.
- Create derivative works or modified versions.
- Train, fine-tune, or evaluate machine learning or AI models using the Software or its outputs.
- Extract datasets, schemas, prompts, or workflows for reuse.
- Reverse engineer or attempt to reconstruct design intent beyond normal evaluation.
...
6. TERMINATION
Any violation of this license immediately terminates all permissions granted herein.

Future versions may be released under different licensing terms at the sole discretion of the Author.
